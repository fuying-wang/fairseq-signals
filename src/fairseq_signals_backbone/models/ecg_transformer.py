...
# from fairseq_signals_backbone.models import register_model
from fairseq_signals_backbone.models.transformer import (
    TransformerConfig,
    TransformerModel,
...
from fairseq_signals_backbone.distributed import utils as dist_utils
...
class ECGTransformerFinetuningModel(TransformerFinetuningModel):
    ...
    @classmethod
    def build_model(cls, cfg: ECGTransformerFinetuningConfig, task):
        """Build a new model instance."""
