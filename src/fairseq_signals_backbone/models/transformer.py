...
from fairseq_signals_backbone.data.data_utils import compute_mask_indices
from fairseq_signals_backbone.models.pretraining_model import PretrainingConfig, PretrainingModel
from fairseq_signals_backbone.models.finetuning_model import FinetuningConfig, FinetuningModel
from fairseq_signals_backbone.modules import (
    TransformerEncoder,
)
from fairseq_signals_backbone.dataclass import ChoiceEnum
...
class TransformerFinetuningModel(FinetuningModel):
    ...
    @classmethod
    def build_model(cls, cfg: TransformerFinetuningConfig, task):
        """Build a new model instance."""
