...
from fairseq_signals_backbone.dataclass.configs import Config
...
def add_defaults(cfg: DictConfig) -> None:
    ...
    from fairseq_signals_backbone.models import ARCH_MODEL_NAME_REGISTRY, MODEL_DATACLASS_REGISTRY
    from fairseq_signals_backbone.dataclass.utils import merge_with_parent
